...
History     : 2024-05-00 Seunghwan Shin       # [v.1.0.0] first create
*/
mod common;
use common::*;
...
async fn main() {
    ...
    let main_controller: MainController<IndexClearServicePub> = MainController::new(Arc::new(index_clear_service));
